        ...
        <div class="container">
            <div class="row justify-content-center text-center mb-5">
                <div class="col-lg-6">
                    ...
                    <p>Let us take you to your dream destinations. Checkout the packages we offer. We bet you'll love it!
                    </p>
                </div>
            </div>
            <div class="row">
                @foreach ($packages as $item)
                    <div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
                        <div class="media-1"><img style="height: 270px;width:500px;" src="../images/{{ $item->image_url }}"
